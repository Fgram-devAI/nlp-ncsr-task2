...
| B    | Traditional text classification (NB / SVM)  | not started |
...
├── requirements.txt
├── .gitignore
├── notebooks/                      # one notebook per part (final deliverable form)
│   └── part_a_embeddings.ipynb
└── part_a_embeddings/              # Part A scripts
    ├── embeddings_utils.py         # shared loaders + helpers
    ├── a1_given_words.py
    ├── a2_own_words.py
    ├── a3_student.py
    ├── a4_given_analogies.py
    ├── a5_own_analogies.py
    ├── a6_tsne_glove.py
    └── figures/
        └── tsne_glove_a6.png
